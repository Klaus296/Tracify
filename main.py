...
first_text = ["Привіт!", "Чому ти тут гуляєшь так пізно?", "Я зрозумів...","Ти шукаєш артефакт","Виходить, ти вже чув, про те що Темаріус шукає артефакти, кажуть що він зібрав вже всі, окрім вогню. Зібравши всі у нього буде така сила, що він зможе володіти Всесвітом. У легендах говориться що лиш лдин із міста вогню зможе перемогти його","Заходь у портал, я поясню що робити."]
